...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			if($user_cover == "deff.png"){
				echo "<div>
					<div><img id='cover-img' class='img-rounded' src='cover/deff.png' alt='cover'></div>";
			}else{
				echo "<div>
				<div><img id='cover-img' class='img-rounded' src='cover/$user_cover' alt='cover'></div>";
			}
			echo"<form action='profile.php?u_id=$user_id' method='post' enctype='multipart/form-data'>
			...
			<div id='profile-img'>
				";
			if($user_image == "def_dp.png"){
				echo "
				<img src='users/def_dp.png' alt='Profile' class='img-circle' width='180px' height='185px'>";
			}else{
				echo "
