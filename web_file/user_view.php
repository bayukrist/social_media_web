                    ...
                    if($content=="No" && strlen($upload_image) >=1){
                        echo "
                            <div id='own_posts'>
                                ...
                                <a href='functions/delete_admin.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a>
                                <a href='single_admin.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'>View</button></a>
                            </div><br><br>
                            ";
                    }
